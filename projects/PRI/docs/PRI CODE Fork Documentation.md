# PIFSC Resource Inventory Containerized Oracle Developer Environment

## Overview
The PIFSC Containerized Oracle Developer Environment (CODE) project was developed to provide a containerized Oracle development environment for PIFSC software developers. The PIFSC Resource Inventory (PRI) was forked from the CODE project or a downstream forked CODE project to extend the CODE project's functionality and integrate PRI's dependencies. This repository can be forked to extend the existing functionality to any data systems that depend on the PRI for both development and testing purposes.

## Resources
-   ### Version Control Information
    -   URL: <https://github.com/noaa-pifsc/PIFSC-PRI-Containerized-Oracle-Development-Environment>
    -   Version: 1.1 (git tag: PRI_CODE_v1.1)
...
-   Custom Dependencies:
    ...
    -   ### PRI Version Control Information
        -   folder path: [/projects/PRI/modules/PRI](../../PRI/modules/PRI) 
        -   Version Control Information:
            -   URL: <git@github.com:noaa-pifsc/PIFSC-Resource-Inventory.git>
            -   Application Version: 1.8 (Git tag: PRI_docker_app_v1.8)
            -   Database Version: 1.0 (Git tag: pifsc_resource_inventory_db_v1.0)
...
-   The PRI container application is available at the following URL by default: 
    -   URL: http://localhost:50200
    -   \*Note: the port can be changed by updating CONTAINER_APP_PORT variable value in the [pri_runtime_config.sh](../config/pri_runtime_config.sh) configuration file
